...
def create_timestamped_movie(date:datetime.date, save_dir:str, movie_dir:str, wavelength:str='558') -> None:
    ...
    movie_dir - base directory to store keogram image
    save_dir - base directory to where raw images are stored.
